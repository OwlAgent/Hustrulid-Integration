...
/**
 * Contains the comments and code required for the PSI.
 * 
 * @author Stefan
 *
 */
public class Psi {
  ...
  public void runPsi() {
    ...
    System.out.println(
        "A variable refers to a specific location in memory where information is " + "stored");
    ...
    System.out
        .println("PSI 2: Compare two String objects by using the compareTo and equals methods "
    ...
    /*
     * operator precedence: closer to top is higher precedence expr++ expr-- ++expr --expr +expr
     * -expr ~ ! * / % + - << >> >>> < > <= >= instanceof == != & ^ | && || ? : = += -= *= /= %= &=
     * ^= |= <<= >>= >>>=
     */
    ...
    System.out
        .println("PSI 2: Use for loops " + "\n\tlocation: SudokuBoardV3.printSolution(int[][])\n");

    System.out
        .println("PSI 2: Use do/while loops " + "\n\tlocation: Minesweeper.playMinesweeper()\n");
